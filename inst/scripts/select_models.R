...
#' @param model_level Specific the TOP model hierarchy level: 'top', 'middle', 'bottom', or 'best'.
...
#'
#' @examples
select_model_coef_mean <- function(pwm_id, cell_type, tf_pwm_training_list, model_coefficients, model_level = 'best') {
