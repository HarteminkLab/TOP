...
We provided some [example pipelines][TOP-snakemake-pipeline] that we used in our paper. 
...
[TOP-snakemake-pipeline]: https://github.com/HarteminkLab/TOP-paper-resources/tree/main/code/snakemake
[bedtools]: https://bedtools.readthedocs.io/en/latest/
