...
many cell types or conditions. [Here][TOP-snakemake-pipeline]
is for an example pipeline that we used in our paper. 
...
[TOP-snakemake-pipeline]:https://github.com/kevinlkx/TOP_pipeline
[bedtools]: https://bedtools.readthedocs.io/en/latest/
