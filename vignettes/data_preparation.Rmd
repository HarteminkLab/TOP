...
Here we show an example procedure for preparing input data for TOP 
...
It is recommended to write [Snakemake pipelines](https://github.com/kevinlkx/TOP/tree/main/inst/snakemake) 
