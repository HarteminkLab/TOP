...
system.time(
  count_genome_cuts_bedtools(bam_file='A549.ATAC.chr21.bam', 
                           chrom_size_file='hg38.chrom.sizes', 
                           shift_ATAC=TRUE,
                           outdir='processed_data',
                           outname='A549.ATAC.chr21.v1',
                           bedtools_path='bedtools',
                           bedGraphToBigWig_path='bedGraphToBigWig'))
```

```{r count_genome_coverage_2, eval=FALSE}
# bam_file: sorted BAM file.
# chrom_size_file: file of genome sizes by chromosomes.
# outdir: directory for saving the BigWig files of genome counts.
# outname: prefix for the BigWig files, same as genomecount_name in get_sites_counts().
...
# bedGraphToBigWig_path: path to UCSC bedGraphToBigWig executable.
system.time(
  count_genome_cuts_bw(bam_file='A549.ATAC.chr21.bam', 
                       chrom_size_file='hg38.chrom.sizes', 
                       shift_ATAC=TRUE,
                       outdir='processed_data',
                       outname='A549.ATAC.chr21.v2',
                       bedGraphToBigWig_path='bedGraphToBigWig'))
```
...
#                                      bwtool_path='bwtool')
system.time(
  sites_counts.mat1 <- get_sites_counts_bwtool(sites,
                                              bam_file='A549.ATAC.chr21.bam',
                                              chrom_size_file='hg38.chrom.sizes', 
                                              shift_ATAC=TRUE,
                                              genomecount_dir='processed_data',
                                              genomecount_name='A549.ATAC.chr21.v1'))

system.time(
  sites_counts.mat3 <- get_sites_counts_bwtool(sites,
                                              bam_file='A549.ATAC.chr21.bam',
                                              chrom_size_file='hg38.chrom.sizes', 
                                              shift_ATAC=TRUE,
                                              genomecount_dir='processed_data',
                                              genomecount_name='A549.ATAC.chr21.v3'))
...
#'                                      
system.time(
  sites_counts.mat2 <- count_sites_cuts(sites,
                                       bam_file='A549.ATAC.chr21.bam',
                                       shift_ATAC=TRUE,
                                       ncores=10))
```
