...
count_normalize_chip = function(sites,
  ...
  # Count total ChIP-seq reads (pooling replicates together)
...
#' @title Normalize (and transform) ChIP-seq read coverage
#' @description Normalize the ChIP-seq read counts by scaling
#' to the reference ChIP-seq library size,
#' and transform the ChIP-seq read counts.
#' @param chip_counts A vector of ChIP-seq counts.
#' @param idxstats_file The idxstats file generated by \code{samtools}.
#' @param ref.size ChIP-Seq reference library size (Default: 20 million).
#' @param transform Type of transformation for the ChIP read counts.
#' Options are 'none' (no transformation), 'asinh', 'log2', and 'sqrt'.
...
#' @description Add ChIP-seq peak labels to the candidate sites.
...
#' @description Add ChIP-seq signals to the candidate sites.
