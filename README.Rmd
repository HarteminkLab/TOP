...
using transcription factor (TF) binding specificity (motifs), DNase- or ATAC-seq data,
as well as ChIP-seq training data from multiple TFs across multiple cell types or conditions. 
