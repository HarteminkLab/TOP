...
You can install the development version of TOP from [GitHub](https://github.com/) with:
...
Please follow the [tutorials](https://kevinlkx.github.io/TOP/articles/index.html) 
